...
* **main.py:** The application entry point that handles the User Interface loop and Menu navigation.

* **corelogic.py:** Combines the business logic and mathematical formulas for financial calculations.

* **database.py:** Manages all file I/O operations, handling data insertion and deletion from crops.json.

* **fallback.py:** Contains static fallback data to ensure the system runs smoothly even if the storage file is missing.

* **testing.py:** A series of unit tests to validate calculation accuracy and error handling.

* **crops.json:** The automatically generated local storage file containing user-defined crop parameters.
...
* **Run the Application:**
Navigate to the project folder using your terminal or command prompt and execute the main script:
...
To run the automated test suite directly without entering the main application menu, use the following command. This is useful for developers verifying code integrity:
